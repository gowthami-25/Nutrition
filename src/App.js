                ...
                <div className="col-md-12 bg-white ">
                  <div className="row">
                    <div className="col-md-12">
                        <h1 className="text-center title">Goli's Nutrition Analysis</h1>
                    </div>
                  </div>
                  <div className="row">
                    <div className="text-center col-md-12">
                      <p className="notes">Enter an ingredient list  for what you are cooking, like <span className="text-success">"1 cup rice,1 cup dal"</span>, etc.,
                      <br/>
                      Enter each ingredient in next line.
                      </p>
